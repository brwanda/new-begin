...
export default function Home() {
  return (
   ...
   style={{
     backgroundImage: "url('https://res.cloudinary.com/dxtjjbk95/image/upload/v1708470192/Authentic%20Events/53437994064_96b0fbc78d_o_qvss2a.jpg')",
     height: "100vh auto",
   }}>
...
<div className="container-fluid mx-auto px-5 py-4 ">
   ...
   <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 text-white">
        <h1 className="sm:text-6xl font-bold py-4">Welcome To Authentic Events!</h1>
        <p className="mt-4 sm:max-w-2xl text-xl py-2">
